...
CJ그룹 내 다양한 플랫폼 상에서 AI비서가 도입 돼, 사용자가 선택하는 데 있어 도움을 줄 수 있었으면 합니다.

CJ제일제당의 공식몰인 CJ 더 마켓로 예를 들겠습니다.
고객이 국을 먹고 싶은데 어떤 상품을 구매해야 하는지, 된장찌개를 하고 싶은데 뭐를 사야 하는지에 대한 질문에, 사용자의 주문 이력과 선호도를 분석해, 사용자에게 최적의 제안(상품)을 제공합니다. 더 나아가, 상품 정보(유통기한, 보관법), 영양 정보, 레시피 등을 제공합니다. 
 답하며, 고객의 요구에 신속하고 정확하게 응답합니다. 이를 통해 CJ 더 마켓은 고객 경험을 향상시키고, 고객들이 더 쉽게 원하는 상품을 찾고 요리를 할 수 있도록 지원합니다.
