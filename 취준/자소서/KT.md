...
KT는 TELECO에서 DIGICO로의 변화를 위해 수많은 노력을 해왔습니다. 
DIGICO 전략을 통해 고객들에게 혁신적인 서비스를 제공하고자는 목표로  ABC(AI, Big Data, Cloud)를 활용하여 디지털 플랫폼 전환을 가속하고, 외부 기업과의 파트너십을 강화함으로써 KT의 역량을 확장해 나갔습니다. 이러한 노력의 결과로 정부가 추진 중인 초거대 AI 생태계 구축 사업에 AI 모델 공급자로 선정되기도 했습니다.

기존의 인식에서 벗어나 경쟁력 있는 새로운 기술을 자신의 사업에 융합하고자 했고, 이런 KT의 방향성에 맞는 사원은 앞으로 나올 새롭고, 경쟁력 있는 기술을 배우고 적용하는 사림일 것입니다.

저는 충분히 그런 사람이라고 생각합니다. 
IT회사의 인턴으로 있을 때, JSP, Jqeury 등을 이용한 프론트 개발 업무를 맡았습니다. 하지만 백엔드 개발자가 다른 업무로 빠지면서, Spring 프레임워크를 처음 배워 백엔드 개발 업무도 맡게 됐습니다. 업무에 차질이 생기지 않기 위해 2주간 퇴근 후 시간을 할애하며 노력한 끝에, 2개월안에 서비스를 배포한 경험이 있습니다.

이처럼, KT에 입사한 후에도 업무 상에 필요하고 경쟁력 있는 기술을 배워나가고 KT의 플랫폼에 적용하고자 합니다. 
또,  야놀자 부트캠프를 통해 자신이 알고 있는 인사이트를 타인과 공유함으로써 오는 학습의 힘을 알고 있기 떄문에 새롭게 배운 기술에 대한 인사이트를 사내 학습 동아리에서 공유하고자 합니다. 
이를 통해 KT가 DIGICO에서 DIGICO 선도기업으로서 변화하는 데 역할하는 사원이 되겠습니다.
