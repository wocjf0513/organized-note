...
"다양한 시도, 개발자로서의 경쟁력"
기술이 급변하는 상황에서 앞으로 10년 뒤 자신이 뭘 하고 있을지 정확히 알기는 힘듭니다. 
이러한 상황 속에서 새로운 걸 도입하고, 배우려는 기업이 경쟁력을 갖고, 그 기업 내 구성원도 자신의 가치를 높일 수 있을 것입니다. 

CJ올리브 네트웍스는 AI를 활용한 스마트 팩토리부터, 메타버스를 활용한 '브릿지 오피스' 사업, 클라우드 사업 등 다양한 분야에서 새로운 기술과의 융합을 추구합니다.

새로운 걸 배우는 게 경쟁력임을 알고, 
