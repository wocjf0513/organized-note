...
CJ올리브네트웍스의 다양한 신기술관련 개발

-> 개발자로서의 자질, 새로운 기술을 받아 들이는 거
...
"모든 지 고쳐드려요"라는 아이디어를 제안합니다.

모바일/ 웹 플랫폼을 사용하다보면, 불편함을 느낄 때가 있습니다.
예를 들어, 생일이나 전화번호를 적을 때, "자동으로 형식 변환이 되면 변할텐데" 이런 생각이 들 때가 있습니다. 하지만, 이를 기업 측에서 알지 못하는 거 같다고 느낄 때가 있습니다. 