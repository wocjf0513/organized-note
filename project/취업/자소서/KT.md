...
KT는 TELE CO에서 DIGICO로의 변화를 이끄는 중요한 역할을 수행하고 있습니다. DIGICO 전략을 통해 KT는 미래를 대비하고 고객들에게 혁신적인 서비스를 제공하고자 합니다. 또한, ABC를 활용하여 디지털 플랫폼 전환을 가속화하고, 외부 기업과의 파트너십을 강화함으로써 KT의 역량을 확장하고 있습니다.

이러한 노력의 결과로 정부가 추진 중인 초거대 AI 생태계 구축 사업에 AI 모델 공급자로 선정되었습니다. 

이런 KT에게 중요한 역량은
급변하는 IT 트렌드에 맞춰, 새로운 기술을 배워나갈 사람일 것이다.

예전에 IT회사의 인턴으로 있을 때, Spring 프레임워크를 처음 배워
2개월안에 서비스를 출시한 경험이 있다.

업무 상에서 필요하다면, 새로운 걸 배우는 데 크게 두려움이 없기 때문에

KT에 입사한 후에도 항상 변화에 민감하고, 새로운 기술과 아이디어에 개방적이며, 혁신적인 역할을 수행하여 KT가 고객의 성장과 혁신을 이끄는 ICT 파트너로서 빛날 수 있도록 노력하겠습니다.
